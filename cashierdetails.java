...
Connection cn=connection.mycon();
Statement st=cn.createStatement();
st.executeUpdate("insert into cashierdata values('"+a+"','"+b+"','"+c+"','"+d+"','"+e+"')");
cn.close();
...
Connection cn=connection.mycon();
Statement st=cn.createStatement();
st.executeUpdate("update cashierdata set name='"+b+"',password='"+c+"',email_id='"+d+"',phone_no='"+e+"' where cashier_id='"+a+"'");
cn.close();
